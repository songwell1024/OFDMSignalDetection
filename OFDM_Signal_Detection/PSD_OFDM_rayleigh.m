...
% [Pxx1,f]=pburg(sig3_chnl,100,4096*2,fs);  %用AR模型法进行功率谱估计
[Pxx1, f, p] = Burg(sig3_chnl,fs, 'AIC');   %用AR模型法进行功率谱估计
[Pxx2,f1]=pwelch(sig3_chnl,hanning(100),55,4096*2,fs);  %用welch算法进行功率谱估计
...
P4=Pxx1(L2:end,1);
if snr>4
    [as3, as33]=Proximate(-6,P3);  %取最接近-3db的信号的f的值
    band3=f(as3);
